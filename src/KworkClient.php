...
use Kwork\Contract\MessagingClientInterface;
 ...
 */
class KworkClient extends KworkAPI implements DialogLookupInterface
{
    ...
    /**
     * Fetch all project pages for the given filters.
     *
     * @param list<int|string> $categoriesIds
     * @return list<WantWorker>
     */
    public function getAllProjects(
        ...
        while (true) {
            ...
            array_push($projects, ...$pageProjects);
            ++$page;
        }
    ...
    /**
     * Find a dialog by interlocutor username.
     */
    public function findDialogByUsername(string $username): ?DialogMessage
    {
        $page = 1;
        ...
        while (true) {
            ...
            foreach ($dialogs as $dialog) {
                if ($dialog->username !== null && strcasecmp($dialog->username, $username) === 0) {
                    return $dialog;
                }
            }
    ...
    {
        return $this->request('post', 'notificationsRead', true);
    }
}
